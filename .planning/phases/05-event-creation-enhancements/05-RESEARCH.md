...
| NEXT*PUBLIC*\* must not expose secrets                   | `GOOGLE_MAPS_API_KEY` already server-only (existing proxy routes confirm this); never add NEXT_PUBLIC_GOOGLE_MAPS_API_KEY      |
