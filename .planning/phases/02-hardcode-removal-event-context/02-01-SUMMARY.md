...
dependency_graph:
  ...
  affects: [lib/engines/rules.ts, lib/engines/referee.ts, lib/engines/field.ts, lib/engines/weather.ts, lib/engines/unified.ts]
tech_stack:
  added: []
...
|---|------|--------|---------------|
| 1 | Parameterize rules.ts with eventId and fix cache | c79d743 | lib/engines/rules.ts, __tests__/lib/engines/rules.test.ts, vitest.config.ts |
...
- **Files modified:** lib/engines/rules.ts, __tests__/lib/engines/rules.test.ts
